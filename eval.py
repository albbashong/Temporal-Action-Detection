...
if __name__ == '__main__':
    ...
    parser.add_argument('--config', type=str, metavar='DIR', default='./configs/thumos_i3d.yaml',
                        help='path to a config file')
    parser.add_argument('--ckpt', type=str, metavar='DIR', default='./ckpt/thumos_i3d_2023-07-14/epoch_035.pth.tar',
