...
def train_one_epoch(
    ...
    for iter_idx, video_list in enumerate(train_loader, 0):
        ...
        #     print(name)
        # layer_name = "module.cls_head.norm.1.weight"  # Specify the name of the layer
        # layer_params = dict(model.named_parameters())[layer_name]
        # weight_diff = torch.norm(layer_params.data - layer_params.data - layer_params.grad)
        # print(weight_diff.item())
